...
#include<iostream>
using namespace std;
	//Write a function that obtains value from the user and returns a value for unitCst, units, and taxRt to the calling module. Choose an appropriate name for this function.
	...
	//Write a function that receives the unitCst, units, and taxRt and returns to the calling module the salesTx and totDue. Choose a better name for this function.
	void returnsTaxandDue(int a,int b,double c,int &d,int &e)	
		{
		d=a*b*c;
		e=(a*b)+d;
	}
	//Write a function that receives the unitCst, units, taxRt, salesTx, and totDue and outputs them in a very readable format. Choose a better name for this function.
